...
INSERT INTO usr (last_name, first_name, patronymic, phone_number, email, birth_date, password) VALUES ('Иванов', 'Иван', 'Иванович', '1234567890', 'test0@example.com', '2000-01-01', '123');
INSERT INTO user_role (user_id, role) VALUES ((SELECT id FROM usr WHERE email = 'test0@example.com'), 'ROLE_ORGANIZER');
